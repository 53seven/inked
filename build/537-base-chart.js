(function (global, factory) {
     ...
     * // => false
     */
    var isBuffer = !Buffer ? constant$2(false) : function(value) {
    ...
    function isEmpty(value) {
      ...
      return !(nonEnumShadows$2 && keys(value).length);
    }
    ...
    function toArray(value) {
      ...
      var tag = getTag$1(value),
          func = tag == mapTag$7 ? mapToArray : (tag == setTag$7 ? setToArray : values);
    ...
    function wrap(value, wrapper) {
      wrapper = wrapper == null ? identity$1 : wrapper;
    ...
    var array = {
      ...
      pullAllWith, pullAt, remove: remove$1, reverse, slice,
    ...
    var object$1 = {
      assign, assignIn, assignInWith, assignWith, create: create$1,
    ...
    var util = {
      attempt, bindAll, cond, conforms, constant: constant$2,
      flow, flowRight, identity: identity$1, iteratee, matches,
    ...
    function formatWeekNumberSunday(d, p) {
      return pad$1(timeSunday.count(timeYear(d), d), p, 2);
    }
    ...
    function formatWeekNumberMonday(d, p) {
      return pad$1(timeMonday.count(timeYear(d), d), p, 2);
    }
    ...
    class Measure {
      ...
      constructor(opts) {
        opts = opts || {};
        this.scale(opts.scale || linear$2());
    ...
    class TimeSeries extends LineChart {
      ...
      plot() {
        ...
        var xAxis = axisBottom().scale(this.x().scale());
        var yAxis = axisLeft().scale(this.y().scale());
