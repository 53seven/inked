(function (global, factory) {
    ...
    typeof define === 'function' && define.amd ? define('537-base-chart', ['exports'], factory) :
    (factory((global.$537 = global.$537 || {})));
    ...
    function scaleTime() {
      return calendar(timeYear, month, timeSunday, timeDay, hour$1, minute$1, second, millisecond, timeFormat).domain([new Date(2000, 0, 1), new Date(2000, 0, 2)]);
    }
    ...
    class TimeSeries extends LineChart {
      ...
      plot(data) {
        ...
        var xAxis = axisBottom().scale(this.x());
        var yAxis = axisLeft().scale(this.y());
     ...
     */
    var baseSetData = !metaMap ? identity$6 : function(func, data) {
    ...
    function rest(func, start) {
      ...
      start = nativeMax$3(start === undefined ? (func.length - 1) : toInteger(start), 0);
      return function() {
        var args = arguments,
            index = -1,
    ...
    var propertyIsEnumerable$3 = objectProto$13.propertyIsEnumerable;
    /**
    ...
    /** Built-in value references. */
    var propertyIsEnumerable$2 = objectProto$11.propertyIsEnumerable;
    ...
    function mapDelete(key) {
      ...
      return Map$1 ? data.map['delete'](key) : assocDelete(data.map, key);
    }
    ...
    function hashGet(hash, key) {
      ...
      return hasOwnProperty$9.call(hash, key) ? hash[key] : undefined;
    }
    ...
    function mapGet(key) {
      ...
      return Map$1 ? data.map.get(key) : assocGet(data.map, key);
    }
    ...
    function mapHas(key) {
      ...
      return Map$1 ? data.map.has(key) : assocHas(data.map, key);
    }
     ...
     * of values.
     */
    var objectToString$4 = objectProto$17.toString;
     ...
     * // => 'hi fred!'
     */
    var bind$1 = rest(function(func, thisArg, partials) {
      var bitmask = BIND_FLAG$6;
      if (partials.length) {
        var holders = replaceHolders(partials, getPlaceholder(bind$1));
    ...
    var bindAll = rest(function(object, methodNames) {
      arrayEach(baseFlatten(methodNames, 1), function(key) {
        object[key] = bind$1(object[key], object);
      });
      return object;
    });
     ...
     * of values.
     */
    var objectToString$5 = objectProto$18.toString;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$10 = objectProto$19.hasOwnProperty;
     ...
     * of values.
     */
    var objectToString$6 = objectProto$21.toString;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$11 = objectProto$20.hasOwnProperty;
    ...
    function toPairs(object) {
      return baseToPairs(object, keys$1(object));
    }
    ...
    function assignInDefaults(objValue, srcValue, key, object) {
      if (objValue === undefined ||
          (eq(objValue, objectProto$23[key]) && !hasOwnProperty$13.call(object, key))) {
        return srcValue;
      }
      return objValue;
    }
     ...
     * of values.
     */
    var objectToString$7 = objectProto$24.toString;
    ...
    function cachePush(value) {
      ...
      if (isKeyable(value)) {
        ...
        hash[value] = HASH_UNDEFINED$2;
      }
      else {
        map.set(value, HASH_UNDEFINED$2);
      }
    }
    ...
    function cacheHas(cache, value) {
      ...
      if (isKeyable(value)) {
        ...
        return hash[value] === HASH_UNDEFINED$3;
      }
    ...
    function flatMapDeep(collection, iteratee) {
      return baseFlatten(map$2(collection, iteratee), INFINITY$2);
    }
      ...
      return rest(function(funcs) {
        ...
        return function() {
          ...
          if (wrapper && args.length == 1 &&
              isArray(value) && value.length >= LARGE_ARRAY_SIZE$2) {
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$15 = objectProto$25.hasOwnProperty;
    ...
    function indexOf(array, value, fromIndex) {
      ...
      if (fromIndex < 0) {
        fromIndex = nativeMax$8(length + fromIndex, 0);
      }
    ...
    function baseIntersection(arrays, iteratee, comparator) {
      ...
      while (othIndex--) {
        ...
        maxLength = nativeMin$4(array.length, maxLength);
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$16 = objectProto$26.hasOwnProperty;
     ...
     * of values.
     */
    var objectToString$8 = objectProto$27.toString;
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$17 = objectProto$30.hasOwnProperty;

    /** Built-in value references. */
    var propertyIsEnumerable$4 = objectProto$30.propertyIsEnumerable;
     ...
     * of values.
     */
    var objectToString$11 = objectProto$31.toString;
    ...
    function isRegExp(value) {
      return isObject(value) && objectToString$12.call(value) == regexpTag$4;
    }
    ...
    function max(array) {
      return (array && array.length)
        ? baseExtremum(array, identity$6, gt)
        : undefined;
    }
    ...
    function mean$1(array) {
      return baseMean(array, identity$6);
    }
    ...
    function min$1(array) {
      return (array && array.length)
        ? baseExtremum(array, identity$6, lt)
        : undefined;
    }
    ...
    function toArray(value) {
      ...
      var tag = getTag$1(value),
          func = tag == mapTag$7 ? mapToArray : (tag == setTag$7 ? setToArray : values$1);
    ...
    function random(lower, upper, floating) {
      ...
      if (floating || lower % 1 || upper % 1) {
        ...
        return nativeMin$7(lower + (rand * (upper - lower + freeParseFloat('1e-' + ((rand + '').length - 1)))), upper);
      }
    ...
    function baseRange(start, end, step, fromRight) {
      var index = -1,
          length = nativeMax$10(nativeCeil$3((end - start) / (step || 1)), 0),
          result = Array(length);
    ...
    function sample(collection) {
      var array = isArrayLike(collection) ? collection : values$1(collection),
          length = array.length;
     ...
     * @returns {Array} Returns the slice of `array`.
     */
    function slice$4(array, start, end) {
      var length = array ? array.length : 0;
      if (!length) {
        return [];
      }
    ...
    function baseSortedIndexBy(array, value, iteratee, retHighest) {
      ...
      return nativeMin$8(high, MAX_ARRAY_INDEX);
    }
    ...
    function baseSortedIndex(array, value, retHighest) {
      ...
      return baseSortedIndexBy(array, value, identity$6, retHighest);
    }
    ...
    function spread(func, start) {
      ...
      start = start === undefined ? 0 : nativeMax$11(toInteger(start), 0);
      return rest(function(args) {
    ...
    function times(n, iteratee) {
      ...
      var index = MAX_ARRAY_LENGTH$6,
          length = nativeMin$9(n, MAX_ARRAY_LENGTH$6);
     ...
     */
    var createSet = !(Set$1 && new Set$1([1, 2]).size === 2) ? noop$1 : function(values) {
    ...
    function unzip(array) {
      ...
      array = arrayFilter(array, function(group) {
        if (isArrayLikeObject(group)) {
          length = nativeMax$12(group.length, length);
          return true;
        }
      });
    ...
    function wrap(value, wrapper) {
      wrapper = wrapper == null ? identity$6 : wrapper;
    ...
    var array$2 = {
      ...
      zip: zip$1, zipObject, zipObjectDeep, zipWith
    };
    ...
    var collection = {
      ...
      invokeMap, keyBy, map: map$2, orderBy, partition,
      reduce, reduceRight, reject, sample, sampleSize,
      shuffle: shuffle$1, size, some, sortBy
    };
    ...
    var lang = {
      ...
      isError, isFinite: isFinite$1, isFunction, isInteger, isLength,
      isMap, isMatch, isMatchWith, isNaN: isNaN$1, isNative,
    ...
    var math = {
      ...
      maxBy, mean: mean$1, meanBy, min: min$1, minBy,
      multiply, round, subtract, sum: sum$2, sumBy
    };
    ...
    var object$1 = {
      ...
      defaults, defaultsDeep, entries: toPairs, entriesIn: toPairsIn, extend: assignIn,
      extendWith: assignInWith, findKey, findLastKey, forIn, forInRight,
      forOwn, forOwnRight, functions, functionsIn, get,
      has, hasIn, invert, invertBy, invoke,
      keys: keys$1, keysIn, mapKeys, mapValues, merge: merge$1,
      mergeWith, omit, omitBy, pick, pickBy,
      result, set: set$1, setWith, toPairs, toPairsIn,
      transform, unset, update, updateWith, values: values$1,
      valuesIn
    };
    ...
    function lazyValue() {
      var array = this.__wrapped__.value(),
          ...
          resIndex = 0,
          takeCount = nativeMin$11(length, this.__takeCount__);
    ...
    /** Used to check objects for own properties. */
    var hasOwnProperty$18 = objectProto$34.hasOwnProperty;
    ...
    lodash.chunk = array$2.chunk;
    lodash.compact = array$2.compact;
    lodash.concat = array$2.concat;
    ...
    lodash.difference = array$2.difference;
    lodash.differenceBy = array$2.differenceBy;
    lodash.differenceWith = array$2.differenceWith;
    lodash.drop = array$2.drop;
    lodash.dropRight = array$2.dropRight;
    lodash.dropRightWhile = array$2.dropRightWhile;
    lodash.dropWhile = array$2.dropWhile;
    lodash.fill = array$2.fill;
    lodash.filter = collection.filter;
    lodash.flatMap = collection.flatMap;
    lodash.flatMapDeep = collection.flatMapDeep;
    lodash.flatMapDepth = collection.flatMapDepth;
    lodash.flatten = array$2.flatten;
    lodash.flattenDeep = array$2.flattenDeep;
    lodash.flattenDepth = array$2.flattenDepth;
    lodash.flip = func.flip;
    lodash.flow = util.flow;
    lodash.flowRight = util.flowRight;
    lodash.fromPairs = array$2.fromPairs;
    lodash.functions = object$1.functions;
    lodash.functionsIn = object$1.functionsIn;
    lodash.groupBy = collection.groupBy;
    lodash.initial = array$2.initial;
    lodash.intersection = array$2.intersection;
    lodash.intersectionBy = array$2.intersectionBy;
    lodash.intersectionWith = array$2.intersectionWith;
    ...
    lodash.pull = array$2.pull;
    lodash.pullAll = array$2.pullAll;
    lodash.pullAllBy = array$2.pullAllBy;
    lodash.pullAllWith = array$2.pullAllWith;
    lodash.pullAt = array$2.pullAt;
    lodash.range = util.range;
    lodash.rangeRight = util.rangeRight;
    lodash.rearg = func.rearg;
    lodash.reject = collection.reject;
    lodash.remove = array$2.remove;
    lodash.rest = rest;
    lodash.reverse = array$2.reverse;
    lodash.sampleSize = collection.sampleSize;
    lodash.set = object$1.set;
    lodash.setWith = object$1.setWith;
    lodash.shuffle = collection.shuffle;
    lodash.slice = array$2.slice;
    lodash.sortBy = collection.sortBy;
    lodash.sortedUniq = array$2.sortedUniq;
    lodash.sortedUniqBy = array$2.sortedUniqBy;
    lodash.split = string$1.split;
    lodash.spread = func.spread;
    lodash.tail = array$2.tail;
    lodash.take = array$2.take;
    lodash.takeRight = array$2.takeRight;
    lodash.takeRightWhile = array$2.takeRightWhile;
    lodash.takeWhile = array$2.takeWhile;
    lodash.tap = seq.tap;
    ...
    lodash.union = array$2.union;
    lodash.unionBy = array$2.unionBy;
    lodash.unionWith = array$2.unionWith;
    lodash.uniq = array$2.uniq;
    lodash.uniqBy = array$2.uniqBy;
    lodash.uniqWith = array$2.uniqWith;
    lodash.unset = object$1.unset;
    lodash.unzip = array$2.unzip;
    lodash.unzipWith = array$2.unzipWith;
    ...
    lodash.without = array$2.without;
    lodash.words = string$1.words;
    lodash.wrap = func.wrap;
    lodash.xor = array$2.xor;
    lodash.xorBy = array$2.xorBy;
    lodash.xorWith = array$2.xorWith;
    lodash.zip = array$2.zip;
    lodash.zipObject = array$2.zipObject;
    lodash.zipObjectDeep = array$2.zipObjectDeep;
    lodash.zipWith = array$2.zipWith;
    ...
    lodash.findIndex = array$2.findIndex;
    lodash.findKey = object$1.findKey;
    lodash.findLast = collection.findLast;
    lodash.findLastIndex = array$2.findLastIndex;
    ...
    lodash.head = array$2.head;
    lodash.identity = identity$6;
    lodash.includes = collection.includes;
    lodash.indexOf = array$2.indexOf;
    lodash.inRange = number$3.inRange;
    ...
    lodash.join = array$2.join;
    lodash.kebabCase = string$1.kebabCase;
    lodash.last = last;
    lodash.lastIndexOf = array$2.lastIndexOf;
    ...
    lodash.sortedIndex = array$2.sortedIndex;
    lodash.sortedIndexBy = array$2.sortedIndexBy;
    lodash.sortedIndexOf = array$2.sortedIndexOf;
    lodash.sortedLastIndex = array$2.sortedLastIndex;
    lodash.sortedLastIndexBy = array$2.sortedLastIndexBy;
    lodash.sortedLastIndexOf = array$2.sortedLastIndexOf;
    ...
    arrayEach(['drop', 'take'], function(methodName, index) {
      LazyWrapper.prototype[methodName] = function(n) {
        ...
        n = n === undefined ? 1 : nativeMax$13(toInteger(n), 0);

        var result = this.clone();
        if (filtered) {
          result.__takeCount__ = nativeMin$10(n, result.__takeCount__);
        } else {
          result.__views__.push({
            'size': nativeMin$10(n, MAX_ARRAY_LENGTH$7),
